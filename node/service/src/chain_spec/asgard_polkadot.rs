...
pub fn asgard_polkadot_genesis(
			...
			keys: invulnerables
				...
				.map(|(acc, aura)| {
					(
						...
						asgard_polkadot_runtime::SessionKeys { aura }, // session keys
					)
				})
				.collect(),
		},
...
pub fn local_testnet_config(id: ParaId) -> Result<ChainSpec, String> {
	Ok(ChainSpec::from_genesis(
		"Asgard-Polkadot Local Testnet",
		"asgard_polkadot_local_testnet",
		ChainType::Local,
...
pub fn chainspec_config(id: ParaId) -> ChainSpec {
	...
	ChainSpec::from_genesis(
		"Bifrost Asgard Polkadot CC4",
		"asgard_polkadot_testnet",
		ChainType::Custom("Asgard Polkadot Testnet".into()),
		move || asgard_polkadot_config_genesis(id),
		vec![],
...
fn asgard_polkadot_config_genesis(id: ParaId) -> GenesisConfig {
...
pub fn faucet_accounts() -> Vec<AccountId> {
	vec![
		hex!["ce6072037670ca8e974fd571eae4f215a58d0bf823b998f619c3f87a911c3541"].into(), /* asgard polkadot sudo account */
