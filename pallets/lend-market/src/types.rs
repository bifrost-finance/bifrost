...
pub struct BorrowSnapshot<Balance> {
	/// Principal Total balance (with accrued interest), after applying the most recent
...
pub struct Market<Balance> {
	...
	/// A liquidation_threshold ratio more than collateral_factor to avoid liquidate_borrow too
	/// casual
