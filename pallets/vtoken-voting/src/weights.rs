...
impl<T: frame_system::Config> WeightInfo for BifrostWeight<T> {
	...
	fn vote_new() -> Weight {
		...
		Weight::from_parts(133_000_000, 17876)
	...
	fn vote_existing() -> Weight {
		...
		Weight::from_parts(135_000_000, 18251)
			.saturating_add(T::DbWeight::get().reads(15_u64))
	...
	fn unlock() -> Weight {
		...
		Weight::from_parts(67_000_000, 17128)
	...
	fn remove_delegator_vote() -> Weight {
		...
		Weight::from_parts(41_000_000, 4430)
	...
	fn kill_referendum() -> Weight {
		...
		Weight::from_parts(17_000_000, 3553)
	...
	fn set_delegator_role() -> Weight {
		...
		Weight::from_parts(19_000_000, 3837)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: VtokenVoting ReferendumInfoFor (r:1 w:1)
