...
pub trait WeightInfo {
	...
	fn set_xcm_task_fee() -> Weight;
	fn set_protocol_fee_rate() -> Weight;
	fn set_update_ongoing_time_unit_interval() -> Weight;
	fn set_update_token_exchange_rate_limit() -> Weight;
...
impl WeightInfo for () {
	...
	fn add_delegator() -> Weight {
		...
		Weight::from_parts(23_000_000, 3533)
	...
	fn remove_delegator() -> Weight {
		...
		Weight::from_parts(20_000_000, 3717)
			.saturating_add(RocksDbWeight::get().reads(7_u64))
			.saturating_add(RocksDbWeight::get().writes(5_u64))
	}
	/// Storage: `SlpV2::ValidatorsByStakingProtocol` (r:1 w:1)
	/// Proof: `SlpV2::ValidatorsByStakingProtocol` (`max_values`: None, `max_size`: Some(34019), added: 36494, mode: `MaxEncodedLen`)
	/// Storage: `System::Number` (r:1 w:0)
	/// Proof: `System::Number` (`max_values`: Some(1), `max_size`: Some(4), added: 499, mode: `MaxEncodedLen`)
	/// Storage: `System::ExecutionPhase` (r:1 w:0)
	/// Proof: `System::ExecutionPhase` (`max_values`: Some(1), `max_size`: Some(5), added: 500, mode: `MaxEncodedLen`)
	...
	fn add_validator() -> Weight {
		...
		Weight::from_parts(11_000_000, 37484)
	...
	fn remove_validator() -> Weight {
		...
		Weight::from_parts(13_000_000, 37484)
			.saturating_add(RocksDbWeight::get().reads(5_u64))
			.saturating_add(RocksDbWeight::get().writes(3_u64))
	}
	/// Storage: `SlpV2::XcmFeeByXcmTask` (r:1 w:1)
	/// Proof: `SlpV2::XcmFeeByXcmTask` (`max_values`: None, `max_size`: Some(49), added: 2524, mode: `MaxEncodedLen`)
	/// Storage: `System::Number` (r:1 w:0)
	/// Proof: `System::Number` (`max_values`: Some(1), `max_size`: Some(4), added: 499, mode: `MaxEncodedLen`)
	/// Storage: `System::ExecutionPhase` (r:1 w:0)
	/// Proof: `System::ExecutionPhase` (`max_values`: Some(1), `max_size`: Some(5), added: 500, mode: `MaxEncodedLen`)
	...
	/// Storage: `SlpV2::ProtocolFeeRateByStakingProtocol` (r:1 w:1)
	/// Proof: `SlpV2::ProtocolFeeRateByStakingProtocol` (`max_values`: None, `max_size`: Some(21), added: 2496, mode: `MaxEncodedLen`)
	/// Storage: `System::Number` (r:1 w:0)
	/// Proof: `System::Number` (`max_values`: Some(1), `max_size`: Some(4), added: 499, mode: `MaxEncodedLen`)
	/// Storage: `System::ExecutionPhase` (r:1 w:0)
	/// Proof: `System::ExecutionPhase` (`max_values`: Some(1), `max_size`: Some(5), added: 500, mode: `MaxEncodedLen`)
	...
	fn set_protocol_fee_rate() -> Weight {
		...
		//  Estimated: `3486`
		// Minimum execution time: 10_000_000 picoseconds.
		Weight::from_parts(10_000_000, 3486)
			.saturating_add(RocksDbWeight::get().reads(5_u64))
			.saturating_add(RocksDbWeight::get().writes(3_u64))
	}
	/// Storage: `SlpV2::UpdateOngoingTimeUintIntervalByStakingProtocol` (r:1 w:1)
	/// Proof: `SlpV2::UpdateOngoingTimeUintIntervalByStakingProtocol` (`max_values`: None, `max_size`: Some(21), added: 2496, mode: `MaxEncodedLen`)
	/// Storage: `System::Number` (r:1 w:0)
	/// Proof: `System::Number` (`max_values`: Some(1), `max_size`: Some(4), added: 499, mode: `MaxEncodedLen`)
	/// Storage: `System::ExecutionPhase` (r:1 w:0)
	/// Proof: `System::ExecutionPhase` (`max_values`: Some(1), `max_size`: Some(5), added: 500, mode: `MaxEncodedLen`)
	...
	fn set_update_ongoing_time_unit_interval() -> Weight {
		...
		//  Estimated: `3486`
		// Minimum execution time: 10_000_000 picoseconds.
		Weight::from_parts(11_000_000, 3486)
			.saturating_add(RocksDbWeight::get().reads(5_u64))
			.saturating_add(RocksDbWeight::get().writes(3_u64))
	}
	/// Storage: `SlpV2::UpdateTokenExchangeRateLimitByStakingProtocol` (r:1 w:1)
	/// Proof: `SlpV2::UpdateTokenExchangeRateLimitByStakingProtocol` (`max_values`: None, `max_size`: Some(25), added: 2500, mode: `MaxEncodedLen`)
	/// Storage: `System::Number` (r:1 w:0)
	/// Proof: `System::Number` (`max_values`: Some(1), `max_size`: Some(4), added: 499, mode: `MaxEncodedLen`)
	/// Storage: `System::ExecutionPhase` (r:1 w:0)
	/// Proof: `System::ExecutionPhase` (`max_values`: Some(1), `max_size`: Some(5), added: 500, mode: `MaxEncodedLen`)
	...
	fn set_update_token_exchange_rate_limit() -> Weight {
		...
		//  Estimated: `3490`
		// Minimum execution time: 10_000_000 picoseconds.
		Weight::from_parts(11_000_000, 3490)
			.saturating_add(RocksDbWeight::get().reads(5_u64))
			.saturating_add(RocksDbWeight::get().writes(3_u64))
	}
	...
	/// Storage: `ParachainInfo::ParachainId` (r:1 w:0)
	/// Proof: `ParachainInfo::ParachainId` (`max_values`: Some(1), `max_size`: Some(4), added: 499, mode: `MaxEncodedLen`)
	/// Storage: `SlpV2::XcmFeeByXcmTask` (r:1 w:0)
	/// Proof: `SlpV2::XcmFeeByXcmTask` (`max_values`: None, `max_size`: Some(49), added: 2524, mode: `MaxEncodedLen`)
	fn transfer_back() -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `624`
		...
		Weight::from_parts(21_000_000, 3533)
	...
	/// Storage: `SlpV2::UpdateOngoingTimeUintIntervalByStakingProtocol` (r:1 w:0)
	/// Proof: `SlpV2::UpdateOngoingTimeUintIntervalByStakingProtocol` (`max_values`: None, `max_size`: Some(21), added: 2496, mode: `MaxEncodedLen`)
	...
	fn update_ongoing_time_unit() -> Weight {
		...
		//  Estimated: `3492`
		// Minimum execution time: 20_000_000 picoseconds.
		Weight::from_parts(21_000_000, 3492)
			.saturating_add(RocksDbWeight::get().reads(9_u64))
			.saturating_add(RocksDbWeight::get().writes(4_u64))
	}
	/// Storage: `SlpV2::UpdateTokenExchangeRateLimitByStakingProtocol` (r:1 w:0)
	/// Proof: `SlpV2::UpdateTokenExchangeRateLimitByStakingProtocol` (`max_values`: None, `max_size`: Some(25), added: 2500, mode: `MaxEncodedLen`)
	/// Storage: `ParachainSystem::ValidationData` (r:1 w:0)
	/// Proof: `ParachainSystem::ValidationData` (`max_values`: Some(1), `max_size`: None, mode: `Measured`)
	/// Storage: `ParachainSystem::LastRelayChainBlockNumber` (r:1 w:0)
	/// Proof: `ParachainSystem::LastRelayChainBlockNumber` (`max_values`: Some(1), `max_size`: None, mode: `Measured`)
	/// Storage: `SlpV2::LastUpdateTokenExchangeRateBlockNumber` (r:1 w:0)
	/// Proof: `SlpV2::LastUpdateTokenExchangeRateBlockNumber` (`max_values`: None, `max_size`: Some(21), added: 2496, mode: `MaxEncodedLen`)
	...
	/// Storage: `SlpV2::ProtocolFeeRateByStakingProtocol` (r:1 w:0)
	/// Proof: `SlpV2::ProtocolFeeRateByStakingProtocol` (`max_values`: None, `max_size`: Some(21), added: 2496, mode: `MaxEncodedLen`)
	/// Storage: `SlpV2::LedgerByStakingProtocolAndDelegator` (r:1 w:1)
	/// Proof: `SlpV2::LedgerByStakingProtocolAndDelegator` (`max_values`: None, `max_size`: Some(252), added: 2727, mode: `MaxEncodedLen`)
	/// Storage: `System::Number` (r:1 w:0)
	...
	/// Proof: `SlpV2::PendingStatusByQueryId` (`max_values`: None, `max_size`: Some(74), added: 2549, mode: `MaxEncodedLen`)
	...
	fn astar_dapp_staking() -> Weight {
		...
		Weight::from_parts(31_000_000, 3533)
			.saturating_add(RocksDbWeight::get().reads(9_u64))
			.saturating_add(RocksDbWeight::get().writes(5_u64))
	}
