...
impl<T: frame_system::Config> WeightInfo for BifrostWeight<T> {
	...
	fn register_currency_for_cross_in_out() -> Weight {
		...
		Weight::from_parts(9_000_000, 2517)
	...
	fn add_to_issue_whitelist() -> Weight {
		...
		Weight::from_parts(12_000_000, 2517)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: CrossInOut IssueWhiteList (r:1 w:1)
	...
	fn remove_from_issue_whitelist() -> Weight {
		...
		//  Estimated: `2627`
		// Minimum execution time: 11_000_000 picoseconds.
		Weight::from_parts(11_000_000, 2627)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn cross_in() -> Weight {
		...
		Weight::from_parts(51_000_000, 24349)
	...
	fn register_linked_account() -> Weight {
		...
		Weight::from_parts(19_000_000, 8189)
	...
	fn cross_out() -> Weight {
		...
		Weight::from_parts(43_000_000, 21962)
	...
	fn change_outer_linked_account() -> Weight {
		...
		//  Estimated: `5877`
		// Minimum execution time: 18_000_000 picoseconds.
		Weight::from_parts(19_000_000, 5877)
