...
impl WeightInfo for () {
	...
	fn initialize_delegator() -> Weight {
		...
		Weight::from_parts(27_000_000, 3631)
	...
	fn bond() -> Weight {
		...
		Weight::from_parts(43_000_000, 4094)
	...
	fn bond_extra() -> Weight {
		...
		Weight::from_parts(44_000_000, 4361)
			.saturating_add(RocksDbWeight::get().reads(6_u64))
			.saturating_add(RocksDbWeight::get().writes(3_u64))
	}
	/// Storage: Slp DelegatorLedgers (r:1 w:0)
	...
	fn unbond() -> Weight {
		...
		Weight::from_parts(52_000_000, 4493)
	...
	fn unbond_all() -> Weight {
		...
		Weight::from_parts(49_000_000, 4471)
	...
	fn rebond() -> Weight {
		...
		//  Estimated: `4406`
		// Minimum execution time: 43_000_000 picoseconds.
		Weight::from_parts(44_000_000, 4406)
			.saturating_add(RocksDbWeight::get().reads(6_u64))
			.saturating_add(RocksDbWeight::get().writes(3_u64))
	}
	/// Storage: Slp DelegatorLedgers (r:1 w:0)
	...
	fn delegate() -> Weight {
		...
		//  Estimated: `4428`
		// Minimum execution time: 48_000_000 picoseconds.
		Weight::from_parts(49_000_000, 4428)
			.saturating_add(RocksDbWeight::get().reads(7_u64))
			.saturating_add(RocksDbWeight::get().writes(3_u64))
	}
	/// Storage: Slp DelegatorLedgers (r:1 w:0)
	...
	fn undelegate() -> Weight {
		...
		Weight::from_parts(46_000_000, 4496)
			.saturating_add(RocksDbWeight::get().reads(6_u64))
			.saturating_add(RocksDbWeight::get().writes(3_u64))
	}
	/// Storage: Slp DelegatorLedgers (r:1 w:0)
	...
	fn payout() -> Weight {
		...
		Weight::from_parts(24_000_000, 3832)
	...
	fn liquidize() -> Weight {
		...
		Weight::from_parts(40_000_000, 4077)
	...
	fn chill() -> Weight {
		...
		Weight::from_parts(51_000_000, 4471)
			.saturating_add(RocksDbWeight::get().reads(7_u64))
			.saturating_add(RocksDbWeight::get().writes(3_u64))
	}
	/// Storage: Slp DelegatorsMultilocation2Index (r:1 w:0)
	...
	fn transfer_back() -> Weight {
		...
		Weight::from_parts(31_000_000, 3866)
			.saturating_add(RocksDbWeight::get().reads(3_u64))
	}
	/// Storage: Slp DelegatorsMultilocation2Index (r:1 w:0)
	/// Proof Skipped: Slp DelegatorsMultilocation2Index (max_values: None, max_size: None, mode: Measured)
	...
	fn transfer_to() -> Weight {
		...
		Weight::from_parts(21_000_000, 3763)
	...
	fn convert_asset() -> Weight {
		...
		Weight::from_parts(35_000_000, 4162)
			.saturating_add(RocksDbWeight::get().reads(5_u64))
	...
	fn decrease_token_pool() -> Weight {
		...
		Weight::from_parts(13_000_000, 3503)
			.saturating_add(RocksDbWeight::get().reads(1_u64))
			.saturating_add(RocksDbWeight::get().writes(1_u64))
	}
	...
	fn update_ongoing_time_unit() -> Weight {
		...
		Weight::from_parts(22_000_000, 3742)
			.saturating_add(RocksDbWeight::get().reads(3_u64))
			.saturating_add(RocksDbWeight::get().writes(2_u64))
	}
	...
	fn supplement_fee_reserve() -> Weight {
		...
		Weight::from_parts(23_000_000, 3856)
			.saturating_add(RocksDbWeight::get().reads(3_u64))
	}
	...
	fn charge_host_fee_and_tune_vtoken_exchange_rate() -> Weight {
		...
		Weight::from_parts(91_000_000, 5562)
	...
	fn set_fee_source() -> Weight {
		...
		//  Estimated: `3469`
		// Minimum execution time: 11_000_000 picoseconds.
		Weight::from_parts(12_000_000, 3469)
			.saturating_add(RocksDbWeight::get().reads(1_u64))
			.saturating_add(RocksDbWeight::get().writes(1_u64))
	}
	/// Storage: Slp DelegatorsIndex2Multilocation (r:1 w:1)
	...
	fn add_delegator() -> Weight {
		...
		//  Estimated: `3528`
		// Minimum execution time: 20_000_000 picoseconds.
		Weight::from_parts(21_000_000, 3528)
			.saturating_add(RocksDbWeight::get().reads(3_u64))
			.saturating_add(RocksDbWeight::get().writes(2_u64))
	}
	/// Storage: Slp DelegatorLedgers (r:1 w:1)
	...
	fn remove_delegator() -> Weight {
		...
		//  Estimated: `3805`
		// Minimum execution time: 24_000_000 picoseconds.
		Weight::from_parts(25_000_000, 3805)
			.saturating_add(RocksDbWeight::get().reads(2_u64))
			.saturating_add(RocksDbWeight::get().writes(3_u64))
	}
	...
	fn add_validator() -> Weight {
		...
		Weight::from_parts(16_000_000, 3528)
			.saturating_add(RocksDbWeight::get().reads(2_u64))
			.saturating_add(RocksDbWeight::get().writes(1_u64))
	}
	/// Storage: Slp Validators (r:1 w:1)
	...
	fn remove_validator() -> Weight {
		...
		//  Estimated: `3585`
		// Minimum execution time: 15_000_000 picoseconds.
		Weight::from_parts(16_000_000, 3585)
			.saturating_add(RocksDbWeight::get().reads(1_u64))
			.saturating_add(RocksDbWeight::get().writes(1_u64))
	}
	/// Storage: Slp MinimumsAndMaximums (r:1 w:0)
	...
	fn set_validators_by_delegator() -> Weight {
		...
		//  Estimated: `3796`
		// Minimum execution time: 23_000_000 picoseconds.
		Weight::from_parts(23_000_000, 3796)
			.saturating_add(RocksDbWeight::get().reads(3_u64))
			.saturating_add(RocksDbWeight::get().writes(1_u64))
	}
	/// Storage: Slp DelegatorLedgers (r:1 w:1)
	...
	fn set_delegator_ledger() -> Weight {
		...
		Weight::from_parts(18_000_000, 3707)
			.saturating_add(RocksDbWeight::get().reads(1_u64))
			.saturating_add(RocksDbWeight::get().writes(1_u64))
	}
	...
	fn set_ongoing_time_unit_update_interval() -> Weight {
		...
		Weight::from_parts(13_000_000, 3469)
			.saturating_add(RocksDbWeight::get().reads(1_u64))
			.saturating_add(RocksDbWeight::get().writes(2_u64))
	}
	...
	fn remove_supplement_fee_account_from_whitelist() -> Weight {
		...
		//  Estimated: `3584`
		// Minimum execution time: 15_000_000 picoseconds.
		Weight::from_parts(15_000_000, 3584)
			.saturating_add(RocksDbWeight::get().reads(1_u64))
			.saturating_add(RocksDbWeight::get().writes(1_u64))
	}
	...
	fn confirm_delegator_ledger_query_response() -> Weight {
		...
		Weight::from_parts(29_000_000, 4062)
			.saturating_add(RocksDbWeight::get().reads(3_u64))
			.saturating_add(RocksDbWeight::get().writes(2_u64))
	}
	/// Storage: Slp DelegatorLedgerXcmUpdateQueue (r:1 w:1)
	...
	fn fail_delegator_ledger_query_response() -> Weight {
		...
		//  Estimated: `3961`
		// Minimum execution time: 20_000_000 picoseconds.
		Weight::from_parts(20_000_000, 3961)
			.saturating_add(RocksDbWeight::get().reads(2_u64))
			.saturating_add(RocksDbWeight::get().writes(1_u64))
	}
	...
	fn confirm_validators_by_delegator_query_response() -> Weight {
		...
		Weight::from_parts(18_000_000, 3694)
			.saturating_add(RocksDbWeight::get().reads(1_u64))
			.saturating_add(RocksDbWeight::get().writes(2_u64))
	}
	/// Storage: Slp ValidatorsByDelegatorXcmUpdateQueue (r:1 w:1)
	...
	fn fail_validators_by_delegator_query_response() -> Weight {
		...
		//  Estimated: `4026`
		// Minimum execution time: 20_000_000 picoseconds.
		Weight::from_parts(21_000_000, 4026)
			.saturating_add(RocksDbWeight::get().reads(2_u64))
			.saturating_add(RocksDbWeight::get().writes(1_u64))
	}
	/// Storage: Slp MinimumsAndMaximums (r:1 w:0)
	...
	fn set_validator_boost_list() -> Weight {
		...
		//  Estimated: `3528`
		// Minimum execution time: 24_000_000 picoseconds.
		Weight::from_parts(25_000_000, 3528)
			.saturating_add(RocksDbWeight::get().reads(2_u64))
			.saturating_add(RocksDbWeight::get().writes(2_u64))
	}
	...
	fn remove_from_validator_boot_list() -> Weight {
		...
		//  Estimated: `3626`
		// Minimum execution time: 13_000_000 picoseconds.
		Weight::from_parts(14_000_000, 3626)
			.saturating_add(RocksDbWeight::get().reads(1_u64))
			.saturating_add(RocksDbWeight::get().writes(1_u64))
	}
}
