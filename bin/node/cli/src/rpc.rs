...
use grandpa::{SharedAuthoritySet, SharedVoterState};
use node_primitives::{
    AccountId, Balance, Block, BlockNumber, ConvertPrice, Hash, Index, TokenSymbol,
};
    ...
    SC: SelectChain<Block> + 'static,
{
    ...
    io.extend_with(brml_assets_rpc::AssetsApi::to_delegate(
        brml_assets_rpc::Assets::new(client.clone()),
    ));
    // register brml-convert rpc handler
    io.extend_with(brml_convert_rpc::ConvertPriceApi::to_delegate(
        brml_convert_rpc::Convert::new(client),
    ));
