...
use node_runtime::{
    ...
    ConvertConfig, CouncilConfig, DemocracyConfig, ElectionsConfig, GrandpaConfig, ImOnlineConfig,
    IndicesConfig, SessionConfig, SessionKeys, SocietyConfig, StakerStatus, StakingConfig,
    SudoConfig, SwapConfig, SystemConfig, TechnicalCommitteeConfig, VoucherConfig, WASM_BINARY,
};
...
pub fn bifrost_genesis(
    ...
    GenesisConfig {
        ...
        pallet_staking: Some(StakingConfig {
            ...
            stakers: initial_authorities[2..5]
                .iter()
                .map(|x| {
                    // we need last three addresses
        ...
        brml_bridge_eos: Some(BridgeEosConfig {
            ...
            notary_keys: initial_authorities[2..5]
                .iter()
                .map(|x| x.0.clone())
                .collect::<Vec<_>>(),
...
fn bifrost_config_genesis() -> GenesisConfig {
    let initial_authorities: Vec<(
        ...
        (
            ...
            hex!["6e2209923b84e44d774cf692a7f4b2f67ffcddbfd1dfbf7bd6f1fb7d769aaf9d"]
                .unchecked_into(),
        ...
        (
            ...
            hex!["af2d88f20650a6048f6d67d26d27636eb7d08ee8d44d2c535946d83257d12e26"]
                .unchecked_into(),
        ...
        (
            ...
            hex!["f1cf7fc925e4c35ab308234b51f72052a9354c71937c481bd8d128626d144de1"]
                .unchecked_into(),
        ...
        (
            ...
            hex!["b7c4f618fcc05c2f3eefeb0454ebb932f10712beca6fa4193e89ebd624133f66"]
                .unchecked_into(),
        ...
        (
            ...
            hex!["20f857f37fff5fbff14292b565bdc6aaa6a5e4e3d04d2a01b2f501dc9bda0b14"]
                .unchecked_into(),
    ...
    bifrost_genesis(initial_authorities, root_key, endowed_accounts)
}
