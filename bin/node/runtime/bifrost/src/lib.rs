...
use frame_support::{
	...
	traits::{Currency, Filter, Imbalance, KeyOwnerProofSystem, OnUnbalanced, Randomness},
};
use frame_system::{
...
use node_primitives::{
	AccountIndex, Balance, BlockNumber, Hash, Index, Moment, CurrencyId, TokenSymbol
};
...
parameter_types! {
	...
	pub const ReportLongevity: u64 = 24 * 28 * 6 * EPOCH_DURATION_IN_SLOTS;
}
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic
	{
		...
		PoaManager: brml_poa_manager::{Pallet, Call, Storage, Event<T>, Config<T>},
