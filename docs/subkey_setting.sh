...
# EOS node address
../target/release/subkey localstorage-set EOS_NODE_URL http://[eos_producer_internal_ip]:8888/ http://127.0.0.1:1234
../target/release/subkey localstorage-set EOS_NODE_URL http://[eos_producer_internal_ip]:8888/ http://127.0.0.1:4321
