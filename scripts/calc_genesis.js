...
console.log(accountBalanceTotal)
fs.writeFileSync('./data/balances.json', JSON.stringify(accountBalanceTotal,null,2));
...
console.log(vestingBalanceTotal)
fs.writeFileSync('./data/vesting.json', JSON.stringify(vestingBalanceTotal,null,2));
