...
impl<T: frame_system::Config> bifrost_vtoken_minting::WeightInfo for BifrostWeight<T> {
	...
	fn set_minimum_mint() -> Weight {
		...
		Weight::from_parts(19_000_000, 4197)
	...
	fn remove_support_rebond_token() -> Weight {
		...
		Weight::from_parts(14_000_000, 3503)
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	...
	fn mint() -> Weight {
		...
		Weight::from_parts(93_000_000, 8769)
	...
	fn redeem() -> Weight {
		...
		Weight::from_parts(110_000_000, 6176)
	...
	fn rebond() -> Weight {
		...
		Weight::from_parts(105_000_000, 8769)
	...
	fn rebond_by_unlock_id() -> Weight {
		...
		Weight::from_parts(100_000_000, 8769)
			.saturating_add(T::DbWeight::get().reads(12))
			.saturating_add(T::DbWeight::get().writes(10))
	}
	// Storage: VtokenMinting OngoingTimeUnit (r:1 w:0)
	...
	fn on_initialize() -> Weight {
		...
		Weight::from_parts(7_000_000, 3492)
			.saturating_add(T::DbWeight::get().reads(1))
	}
}
