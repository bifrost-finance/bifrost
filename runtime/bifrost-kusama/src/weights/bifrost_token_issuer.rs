...
impl<T: frame_system::Config> bifrost_token_issuer::WeightInfo for BifrostWeight<T> {
	...
	fn add_to_issue_whitelist() -> Weight {
		...
		Weight::from_parts(14_000_000, 3607)
	...
	fn remove_from_issue_whitelist() -> Weight {
		...
		Weight::from_parts(42_000_000, 3685)
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	...
	fn add_to_transfer_whitelist() -> Weight {
		...
		//  Estimated: `3607`
		// Minimum execution time: 13_000 nanoseconds.
		Weight::from_parts(13_000_000, 3607)
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	// Storage: TokenIssuer TransferWhiteList (r:1 w:1)
	...
	fn remove_from_transfer_whitelist() -> Weight {
		...
		//  Estimated: `3685`
		// Minimum execution time: 13_000 nanoseconds.
		Weight::from_parts(13_000_000, 3685)
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	...
	fn issue() -> Weight {
		...
		Weight::from_parts(46_000_000, 5335)
	...
	fn transfer() -> Weight {
		...
		Weight::from_parts(55_000_000, 6176)
			.saturating_add(T::DbWeight::get().reads(4))
			.saturating_add(T::DbWeight::get().writes(2))
	}
}
