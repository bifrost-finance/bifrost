...
impl pallet_ranked_collective::Config for Runtime {
	...
	type PromoteOrigin = EitherOf<
		...
		EitherOf<
			...
			TryMapSuccess<custom_origins::EnsureFellowship, CheckedReduceBy<ConstU16<1>>>,
		>,
	>;
	...
	type DemoteOrigin = EitherOf<
		...
		EitherOf<
			MapSuccess<FellowshipAdmin, Replace<ConstU16<9>>>,
			TryMapSuccess<custom_origins::EnsureFellowship, CheckedReduceBy<ConstU16<2>>>,
		>,
	>;
...
construct_runtime! {
		...
		UncheckedExtrinsic = UncheckedExtrinsic,
	{
		...
		FellowshipCollective: pallet_ranked_collective::{Pallet, Call, Storage, Event<T>} = 39,
		Origins: governance::custom_origins::{Origin} = 124,
