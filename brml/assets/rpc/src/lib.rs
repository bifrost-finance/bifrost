...
impl<C, Block, TokenSymbol, AccountId, Balance>
    AssetsApi<<Block as BlockT>::Hash, TokenSymbol, AccountId, Balance> for Assets<C, Block>
where
    Block: BlockT,
    ...
    Balance: Codec,
{
    fn asset_balances(
        ...
        asset_rpc_api
            .asset_balances(&at, token_symbol, who)
            .map_err(|e| RpcError {
