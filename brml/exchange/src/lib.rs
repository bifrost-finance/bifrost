...
pub trait ExchangeTrait: system::Trait {
...
decl_storage! {
	trait Store for Module<T: ExchangeTrait> as ExchangeStore {
...
decl_module! {
	pub struct Module<T: ExchangeTrait> for enum Call where origin: T::Origin {
